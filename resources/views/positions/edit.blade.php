        ...
        <div class="row">
            <form action="{{ route('positions.update', $position->id) }}" method="POST" class="form-horizontal">
                ...
                <fieldset>
                    ...
                    <!-- Form Name -->
                    <legend>Actualiza los datos del puesto: {{ $position->name }}</legend>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="name" name="name" type="text" placeholder="Nombre del puesto" class="form-control input-md" value="{{ $position->name }}">
                    ...
                    <!-- Button -->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="singlebutton">Actualizar puesto</label>
                        <div class="col-md-4">
